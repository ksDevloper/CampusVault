document.addEventListener('DOMContentLoaded', () => {
    ...
    const API_BASE_URL = 'https://campusvault-api.ks8375050.workers.dev'.replace(/\/+$/, '');
    ...
    function renderMaterials() { try {
        ...
        if (filtered.length === 0) {
            ...
            // Re-initialize icons
            lucide.createIcons(); } } catch(err) { alert("RENDER ERROR: " + err.message + " --- " + err.stack); } } // Dynamic Lists Generator
